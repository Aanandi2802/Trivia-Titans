...
import { setLoginUser, setLoginEmail } from "../../redux/isLogin.reducers";
...
export default function GRegistrationPage() {
      ...
      const createAccount = async () => {
        try {
          await axios({
            ...
            data: {
              email: localStorage.getItem("google_login_user_email"),
        ...
        <div className="registration_div">
          <div className="form">
            <div className="reg_tile">
              <span style={{ color: "#1091e1" }}>Set</span> Profile
            </div>
